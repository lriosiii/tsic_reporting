...
SELECT  DISTINCT  sms.SessionDate,  sms.SessionDuration, s.StudentID, m.MentorID, s.LastName + ', ' + s.FirstName AS StudentName, s.MiddleName, m.LastName + ', ' + m.FirstName As MentorName, 
...
INNER JOIN Lookups.MentorStatuses ms ON m.MentorStatusID = ms.MentorStatusID
			...
			--And SessionDate Between '2017-03-01' And '2017-03-31'
