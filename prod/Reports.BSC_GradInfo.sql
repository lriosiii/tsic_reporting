SELECT     o.OfficeID, o.OfficeName, sch.SchoolName, ss.StudentStatusName, s.StudentReferenceID AS StudentID, s.studentid AS StudID, s.LastName + ', ' + s.FirstName AS StudentFullName, 
                      s.MiddleName, s.CurrentGradeLevelID AS CurrentGrade, s.CommunityServiceHours, s.DualEnrollmentCredits, s.APCredits, 
...
LEFT OUTER JOIN  Students.FAFSA sf ON s.StudentID = sf.StudentID
...
LEFT OUTER JOIN Lookups.BrightFutures bf ON s.BrightFutureID = bf.BrightFutureID 
