SELECT     S.FirstName, S.MiddleName, S.LastName, S.LastName + ', ' + S.FirstName AS StudentFullName, S.SSN, o.officename, s.graduationyear, M.EmailAddress as MentorEmail, S.BirthDate, SS.StudentStatusName, 
                      ...
                      + '_' + DATENAME(MM, S.BirthDate) AS BirthdayNumberMonth, S.HomePhoneNumber, S.MobilePhoneNumber, S.WorkPhoneNumber, S.EmailAddress, 
					  ...
					  SAddress.ZipCode AS StudentZipCode, (Select TOP(1) AgencyName From Offices.Contacts oc Where o.OfficeID = oc.OfficeID And oc.IsDeleted = 0 And AgencyName IS NOT NULL) As AgencyName
						 ...
						 (SELECT     TOP (1) sct.StudentContactTypeName
							...
							SC.SchoolName, 
                      AD.FirstName + ' ' + AD.LastName AS AdvocateFullName, DATEDIFF(YY, S.BirthDate, GETDATE()) AS StudentAge
