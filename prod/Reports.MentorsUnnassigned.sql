SELECT     CONVERT(varchar, DecryptByKey(Mentors.Mentors.EncryptedSSN)) AS SSN, Mentors.Mentors.FirstName, Mentors.Mentors.MiddleName, Mentors.Mentors.LastName, CONVERT(varchar, DecryptByKeyAutoCert(cert_ID('Certificate1'), NULL, EncryptedBirthDate)) AS BirthDate,
                      ...
                      Mentors.Mentors.WelcomePacketSent, Mentors.Mentors.AmericorMentor, CONVERT(varchar, DecryptByKeyAutoCert(cert_ID('Certificate1'), NULL, EncryptedDriversLicense)) AS DriversLicense, Mentors.Mentors.IDExpires,
