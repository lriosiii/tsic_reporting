SELECT DISTINCT 
	...
	sch.SchoolName, 
	c.OfficeName, 
    Gr.ContactName AS GuardianFullName, 
	Adr.Address1 + ' ' + Adr.Address2 AS GuardianAddress, 
	Adr.City + ' ' + Adr.StateID AS GuardianCityState, 
    Adr.ZipCode AS GuardianZip, 
	Gr.EmailAddress AS GuardianEmail, 
	Gr.ContactHomePhone AS GuardianHomePh, 
	Gr.ContactCellPhone AS GuardianCellPh, 
...
where (gr.isdeleted IS NULL OR gr.isdeleted = 0) AND s.isdeleted = 0
