...
SELECT      Sal.SalutationName, offices.officename, Mentors.Mentors.LastName, Mentors.Mentors.FirstName, Mentors.Mentors.MiddleName, Mentors.mentors.Gender as MentorGender, Lookups.MentorStatuses.MentorStatusName, Students.StudentMentors.IsPrimary as IsPrimary, CONVERT(varchar, DecryptByKeyAutoCert(cert_ID('Certificate1'), NULL, mentors.mentors.EncryptedBirthDate)) AS BirthDate,
